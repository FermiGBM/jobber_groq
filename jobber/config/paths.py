"""
Path configurations for the jobber project.
"""
import os

PROJECT_SOURCE_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
# Create user preferences folder if it does not exist
